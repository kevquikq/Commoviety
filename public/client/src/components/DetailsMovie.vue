    ...
    <div class="container mt-5">
      ...
      <div class="row">
        <div class="card col-4" style="width:100px">
          ...
          <br>
          <p> Score: </p>
          <p v-if="getPeliculas[index].averageScore"> <svg style="margin-bottom: 10px;" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="gold" class="bi bi-star-fill" viewBox="0 0 16 16">
