    ...
    <div v-if="getPeliculas[index]">
      <div class="container mt-5">
          ...
          <div class="row">
            <div class="card col-4" style="width: 100px">
              ...
              <div v-if="getPeliculas[index].averageScore">
                <p :style="getScoreStyle(getPeliculas[index].averageScore)">
                  <svg
                  ...
                  {{getPeliculas[index].averageScore | puntaje}}
                  <br />
                </p>
                <p style="font-size: 90%">
                  <i
                    >Cantidad de votantes:
                    {{ getPeliculas[index].quantScores }}</i
                  >
                </p>
              </div>
              <div v-else>
                ...
                <div v-if="!puntajeEnviado">
                  <div v-if="obtenerPuntajeUsuarioPelicula">
                    ...
                    <p style="font-size: 65%">
                      Tu puntaje actual:
                      {{ obtenerPuntajeUsuarioPelicula.value }}
                    </p>
                    <br />
                  </div>
                  ...
                  >
                    ...
                    <br />
                    <button
                      class="btn btn-danger my-3 col-12"
        ...
        <div v-if="getUsuarioActual">
          <button
            v-if="!tieneForo"
            @click="asociarForoConUsuario(getPeliculas[index])"
          ...
          <button
            v-else
            @click="irAForo(getPeliculas[index])"
            class="btn btn-danger col-12"
            style="background: #f48660"
          >
            Ir al foro
...
export default {
  ...
  computed: {
    obtenerPuntajeUsuarioPelicula() {
      return this.getPuntajes.find(
        (puntaje) =>
          puntaje.UserId == this.getUsuarioActual.id &&
          puntaje.MovieId == this.index + 1
      );
    },
  },
};
